...
def parse_agrs():
    ...
    # HS-FPN settings
    parser.add_argument('--use_hsfpn', type=bool, default=False, help='whether to use HS-FPN enhanced visual extractor')
    parser.add_argument('--hsfpn_ratio', type=tuple, default=(0.18, 0.15), help='high-pass filter ratio for HFP module')
    parser.add_argument('--hsfpn_output_layer', type=str, default='P3', choices=['P2', 'P3'], help='which pyramid layer to use as output (P2 for more details, P3 for balance)')

    # CCA (Contextual Cross-modal Attention) settings - DSCI论文
    parser.add_argument('--use_cca', type=bool, default=False, help='whether to use CCA module from DSCI paper')
